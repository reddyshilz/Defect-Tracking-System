        ...
        <div class="container">
            <div class="row">
                ...
                <div class="pull-right">
                    <button class="btn btn-info" onclick=" AddDefect();return false;">Add Defect</button>
                    &nbsp; &nbsp;</div>
            </div>
            <div class="row">
                    ...
                    <form role="form" id="defectForm" class="form-horizontal" method="post">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="hidden" class="form-control" id="oldStatus" />
                                <input type="hidden" id="hdnRole" class="form-control"  value="<%=HttpContext.Current.Session["Role"].ToString()%>"  />
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" id="CreatedBy" disabled="disabled" value="<%=HttpContext.Current.User.Identity.Name%>" />
                            </div>
                        </div>
    ...
    <div class="modal fade bs-example-modal-sm" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title" id="deleteModalLabel1"></h4>
                </div>
