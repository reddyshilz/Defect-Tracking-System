    ...
    public static class UserDatasource
    {
        ...
        public static void AddRemoveProject(IEnumerable<ProjectAssignment> assignments)
        {
            ...
            try
            {
                ...
                var strquery = "Delete from dbo.DTSUserProject where ProjectMgrId= '" + loginID + "' And userID=" + projectAssignments[0].UserId;
        ...
        public static IEnumerable<Role> GetRoles()
        {
            ...
            try
            {
                string strquery = "Select * from DTSRole Where IsActive=1 and txt_Role <>'PM'";
                SqlCommand cmd = new SqlCommand(strquery, con);
                con.Open();
                SqlDataReader reader = cmd.ExecuteReader();
                if (reader != null)
