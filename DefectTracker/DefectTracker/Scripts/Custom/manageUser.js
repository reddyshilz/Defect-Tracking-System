//This file contains all the Jquery ajax method to add, edit, delete modal popup open & close
// and call to web method to pariallly do only save, edit, assign user to project, & delete function call
...
$(document).ready(function () {
    ...
    $("#errorPanel").hide();
    //onsubmit of the adduser form ,call webmethod  to save user details 
    ...
    //this method is called after user type userID.It calls the webapi(http://pvamu-empwebapi.azurewebsites.net) with 
    //input parameter as userid and populate the firstname, lastname & emailid from webapi response--written By Prbasini & shilpa
        ...
        $.ajax({
            ...
            success: function (response) {
                if (response.FirstName == '' || !response.FirstName || response.FirstName == undefined) {
                    $("#FirstName").val('NA in WebApi');
                    $("#LastName").val('NA in WebApi');
                    $("#EmailId").val('NA in WebApi');                  
                }
                else{
    ...
    //jquery - ajax call when pm assign project to user
    ...
    //jquery - ajax call when delete a user from user list page 
...
//javascript method to validate required field
